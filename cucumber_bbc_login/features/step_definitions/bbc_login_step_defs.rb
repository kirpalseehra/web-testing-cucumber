...
Given("I input a password with too many characters") do
  @bbc_site.bbc_loginpage.fill_in_password('jasdijsaiodjsaoidjaisodjoiasjdoiasjodjsaiojdoiasjdoij321')
end

Then("I receieve an error for having a password too long") do
  expect(@bbc_site.bbc_loginpage.password_error_messege).to eq @bbc_site.bbc_loginpage.long_password
end